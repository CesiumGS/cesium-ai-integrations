...
export const JulianDateSchema = z.object({
...
export const SampledPositionPropertySchema = z.object({
  type: z.literal('sampled'),
  samples: z.array(PositionSampleSchema),
  interpolationDegree: z.number().optional().default(1),
  interpolationAlgorithm: z.enum(['LINEAR', 'LAGRANGE', 'HERMITE']).optional().default('LINEAR')
}).describe('Time-sampled position property');

export const CallbackPropertySchema = z.object({
...
export const VelocityOrientationPropertySchema = z.object({
...
export const AnimatedPositionSchema = z.union([
  PositionSchema,
  SampledPositionPropertySchema
...
export const ClockSchema = z.object({
  ...
  clockRange: z.enum(['UNBOUNDED', 'CLAMPED', 'LOOP_STOP']).describe('Clock behavior at boundaries'),
  clockStep: z.enum(['TICK_DEPENDENT', 'SYSTEM_CLOCK_MULTIPLIER', 'SYSTEM_CLOCK']).optional().default('SYSTEM_CLOCK_MULTIPLIER'),
...
export const ModelAnimationSchema = z.object({
  loop: z.enum(['NONE', 'REPEAT', 'MIRRORED_REPEAT']).optional().default('NONE'),
  reverse: z.boolean().optional().default(false),
  multiplier: z.number().optional().default(1),
  animationTime: z.object({
    type: z.literal('callback'),
    functionName: z.string()
  }).optional().describe('Custom animation time function')
...
export const PolylineMaterialSchema = z.union([
  z.object({
    type: z.literal('color'),
    color: ColorSchema
  }),
...
export const PointGraphicsSchema = z.object({
  ...
  scaleByDistance: z.object({
    near: z.number(),
    nearValue: z.number(),
    far: z.number(),
    farValue: z.number()
  }).optional(),
  heightReference: z.enum(['NONE', 'CLAMP_TO_GROUND', 'RELATIVE_TO_GROUND']).optional()
}).describe('Point graphics configuration');

export const BillboardGraphicsSchema = z.object({
  show: z.boolean().optional().default(true),
  image: z.string().describe('URL to image file'),
...
export const LabelGraphicsSchema = z.object({
  show: z.boolean().optional().default(true),
  text: z.string(),
  font: z.string().optional().default('14pt monospace'),
  style: z.enum(['FILL', 'OUTLINE', 'FILL_AND_OUTLINE']).optional().default('FILL'),
...
export const ModelGraphicsSchema = z.object({
  show: z.boolean().optional().default(true),
  ...
  animations: z.array(ModelAnimationSchema).optional().describe('Model animation configurations'),
  nodeTransformations: z.record(z.object({
  ...
  })).optional().describe('Node transformations for animation')
}).describe('3D model graphics configuration');

export const PolygonGraphicsSchema = z.object({
  show: z.boolean().optional().default(true),
  hierarchy: z.array(PositionSchema).describe('Array of positions defining polygon boundary'),
  height: z.number().optional().describe('Height above ellipsoid in meters'),
  extrudedHeight: z.number().optional().describe('Height of extrusion in meters'),
...
export const PolylineGraphicsSchema = z.object({
  show: z.boolean().optional().default(true),
  positions: z.array(PositionSchema).describe('Array of positions defining polyline path'),
  ...
  arcType: z.enum(['GEODESIC', 'RHUMB', 'NONE']).optional().default('GEODESIC')
}).describe('Polyline graphics configuration');

export const RectangleGraphicsSchema = z.object({
  show: z.boolean().optional().default(true),
...
export const EllipseGraphicsSchema = z.object({
  show: z.boolean().optional().default(true),
...
export const BoxGraphicsSchema = z.object({
  show: z.boolean().optional().default(true),
  dimensions: z.object({
    x: z.number().min(0),
    y: z.number().min(0),
...
export const CylinderGraphicsSchema = z.object({
  show: z.boolean().optional().default(true),
...
export const EllipsoidGraphicsSchema = z.object({
  show: z.boolean().optional().default(true),
  radii: z.object({
    x: z.number().min(0),
    y: z.number().min(0),
...
export const WallGraphicsSchema = z.object({
  show: z.boolean().optional().default(true),
  positions: z.array(PositionSchema).describe('Array of positions defining wall path'),
  minimumHeights: z.array(z.number()).optional().describe('Array of minimum heights'),
  maximumHeights: z.array(z.number()).optional().describe('Array of maximum heights'),
  fill: z.boolean().optional().default(true),
  material: MaterialSchema.optional(),
  outline: z.boolean().optional().default(false),
  outlineColor: ColorSchema.optional(),
...
export const CorridorGraphicsSchema = z.object({
  show: z.boolean().optional().default(true),
  positions: z.array(PositionSchema).describe('Array of positions defining corridor centerline'),
  ...
  outlineColor: ColorSchema.optional(),
  outlineWidth: z.number().min(0).optional().default(1),
  cornerType: z.enum(['ROUNDED', 'MITERED', 'BEVELED']).optional().default('ROUNDED'),
  granularity: z.number().min(0).optional()
...
export const EntitySchema = z.object({
  ...
  description: z.string().optional().describe('HTML description shown in InfoBox'),
  position: z.union([PositionSchema, SampledPositionPropertySchema]).optional().describe('Entity position (static or animated)'),
  orientation: z.union([
    z.object({
  ...
  ]).optional().describe('Entity orientation (static or velocity-based)'),

  // Animation properties
  availability: TimeIntervalSchema.optional().describe('Time interval when entity is available'),
  viewFrom: z.object({
    x: z.number(),
    y: z.number(),
    z: z.number()
  }).optional().describe('Viewing offset for camera tracking'),
...
}).describe('Complete entity definition with graphics objects and animation support');
